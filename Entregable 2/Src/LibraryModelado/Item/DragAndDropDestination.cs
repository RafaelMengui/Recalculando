...
namespace Proyecto.Item
{
    ...
    {
        public DragAndDropDestination(string Name, Level Level, int PositionX, int PositionY, int Width, int Height, bool Draggable) : base(Name, Level, PositionX, PositionY, Width, Height, Draggable)
        {
        }
