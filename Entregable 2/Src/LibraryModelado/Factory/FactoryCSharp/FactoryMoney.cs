...
namespace Proyecto.Factory.CSharp
{
    ...
    public class FactoryMoney : IFactoryComponent
    {
        ...
        public override IComponent MakeComponent(Tag tag)
        {
            ...
            Items draggabledinero = new Money(this.name, this.level, this.positionX, this.positionY, this.width, this.height, this.image, this.draggable, container, this.value);
