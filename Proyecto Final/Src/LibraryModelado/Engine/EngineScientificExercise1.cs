...
namespace Proyecto.LibraryModelado.Engine
{
    ...
    public class EngineScientificExercise1 : ILevelEngine
    {
        ...
        {
            Feedback feedback = new Feedback("Feedback1", this.Level, 527, -32, 222, 400, "Vacio.png", string.Empty, 23, true, false);
        ...
        {
            ButtonGoToPage goToMain = new ButtonGoToPage("Scientific1ToMain", this.Level, -610, 315, 100, 100, "GoToMain.png", "#FCFCFC", "MenuScientific");
        ...
        {
            ButtonStartLevel goToNext = new ButtonStartLevel("Scientific1ToScientific2", this.Level, 0, 0, 450, 250, "siguienteNivel.png", "#FCFCFC", "ScientificExercise2");
