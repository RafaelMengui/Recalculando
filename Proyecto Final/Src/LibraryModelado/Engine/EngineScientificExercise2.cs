...
namespace Proyecto.LibraryModelado.Engine
{
    ...
    public class EngineScientificExercise2 : ILevelEngine
    {
        ...
        {
            Feedback feedback = new Feedback("Feedback2", this.Level, 527, -32, 222, 400, "Vacio.png", string.Empty, 23, true, false);
        ...
        {
            ButtonGoToPage goToMain = new ButtonGoToPage("Scientific2ToMain", this.Level, -610, 315, 100, 100, "GoToMain.png", "#FCFCFC", "MenuScientific");
        ...
        {
            ButtonStartLevel goToNext = new ButtonStartLevel("Scientific2ToScientific3", this.Level, 0, 0, 450, 250, "siguienteNivel.png", "#FCFCFC", "ScientificExercise3");
